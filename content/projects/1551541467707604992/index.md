...
date = "2026-09-21"
description = "I built a room presence sensor for the various rooms of my home using an ESP32 and an LD2410 mmWave sensor, running ESPHome firmware. After previously getting poor results from LD2410 sensors and struggling with calibration, I wrote a calibrator tool that finally got them working properly, and packaged the whole thing in a small enclosure."
...
Previous experiences with LD2410 sensors had soured me a bit, since they never worked well for me. I initially thought it was a cool sensor, so I bought ten off AliExpress, but then always had bad results with them and couldn't figure out the calibration. Claude explained to me how the sensor worked and helped me write a calibrator, which I've put up at [ld2410-calibrator](https://github.com/skorokithakis/ld2410-calibrator). Now it works amazingly well.
