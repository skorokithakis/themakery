...
date = "2026-09-21"
description = "I built a projects website for the Makery that generates project pages automatically from our Discord. I collect all the Discord messages in a database and use them both for the newsletter and for this site. The site looks at the threads, works out which ones are about a project, pulls in the text and images, and turns each one into a project page."
